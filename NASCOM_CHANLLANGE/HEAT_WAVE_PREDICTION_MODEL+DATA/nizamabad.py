...
Original file is located at
    https://colab.research.google.com/drive/1o97NSoXEXvwfSoCSVm2dLxK-H6Ttzy3y
"""

import pandas as pd
dataset_nizamabad=pd.read_csv('/home/coder/project/workspace/NASCOM_CHANLLANGE/HEAT_WAVE_PREDICTION_MODEL+DATA/nizamabad_dataset_final.csv')

dataset_nizamabad.head()

dataset_nizamabad[10:]

dataset_nizamabad['Date'] = pd.to_datetime(dataset_nizamabad['Date'])

dataset_nizamabad[10:]

dataset_nizamabad['Date'] =dataset_nizamabad['Date'].dt.date

dataset_nizamabad.shape

avg_by_date = dataset_nizamabad.groupby('Date')['temp_max (⁰C)'].mean()
...
normal_temp =(40.33542857530295+39.14925403736359)/2  # Mean maximum temperature in Celsius for the hottest month
...
for i in range(0,12):
  for index, row in dataset[i].iterrows():
    ...
    elif row['ARIMA Predictions'] >= 39.5:
