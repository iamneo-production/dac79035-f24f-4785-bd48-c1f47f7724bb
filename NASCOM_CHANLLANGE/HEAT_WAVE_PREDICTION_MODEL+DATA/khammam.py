...
Original file is located at
    https://colab.research.google.com/drive/1316luhKSvdoSzdGHc_tiIbA6IDx3T4PB
"""

import pandas as pd
dataset_khammam=pd.read_csv('/home/coder/project/workspace/NASCOM_CHANLLANGE/HEAT_WAVE_PREDICTION_MODEL+DATA/khammam_dataset_final.csv')

dataset_khammam.head()

dataset_khammam[10:]

dataset_khammam['Date'] = pd.to_datetime(dataset_khammam['Date'])

dataset_khammam[10:]

dataset_khammam['Date'] =dataset_khammam['Date'].dt.date

dataset_khammam.shape

avg_by_date = dataset_khammam.groupby('Date')['temp_max (?C)'].mean()
...
normal_temp =(38.7+40.2)/2  # Mean maximum temperature in Celsius for the hottest month
...
for i in range(0,12):
  for index, row in dataset[i].iterrows():
    ...
    elif row['ARIMA Predictions'] >= 39.45:
