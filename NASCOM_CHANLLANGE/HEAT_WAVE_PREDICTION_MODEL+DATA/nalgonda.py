...
Original file is located at
    https://colab.research.google.com/drive/1qHUkIff0uwcXSN-U815B29Vssp4UjKGW
"""

import pandas as pd
dataset_nalgonda=pd.read_csv('/home/coder/project/workspace/NASCOM_CHANLLANGE/HEAT_WAVE_PREDICTION_MODEL+DATA/nalgonda_dataset_final.csv')

dataset_nalgonda.head()

dataset_nalgonda[10:]

dataset_nalgonda['Date'] = pd.to_datetime(dataset_nalgonda['Date'])

dataset_nalgonda[10:]

dataset_nalgonda['Date'] =dataset_nalgonda['Date'].dt.date

dataset_nalgonda.shape

avg_by_date = dataset_nalgonda.groupby('Date')['temp_max (⁰C)'].mean()
...
normal_temp =(40.375948060718756+38.493348418587935)/2  # Mean maximum temperature in Celsius for the hottest month
