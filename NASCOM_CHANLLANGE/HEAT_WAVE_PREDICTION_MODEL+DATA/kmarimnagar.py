...
Original file is located at
    https://colab.research.google.com/drive/1RnFPGfw-X6q4riFFnilBNOakVAZ60kBq
"""

import pandas as pd
dataset_karimnagar=pd.read_csv('/home/coder/project/workspace/NASCOM_CHANLLANGE/HEAT_WAVE_PREDICTION_MODEL+DATA/Karimnagar_dataset_final.csv')

dataset_karimnagar.head()

dataset_karimnagar[10:]

dataset_karimnagar['Date'] = pd.to_datetime(dataset_karimnagar['Date'])

dataset_karimnagar[10:]

dataset_karimnagar['Date'] =dataset_karimnagar['Date'].dt.date

dataset_karimnagar.shape

avg_by_date = dataset_karimnagar.groupby('Date')['temp_max (⁰C)'].mean()
...
normal_temp =(40.45284575760392+38.45532343519473)/2  # Mean maximum temperature in Celsius for the hottest month
...
for i in range(0,12):
  for index, row in dataset[i].iterrows():
    ...
    elif row['ARIMA Predictions'] >= 39.4:
