...
Original file is located at
    https://colab.research.google.com/drive/1RIQznOB0xP9QU9b0NgWkNoUunSvV9jP5
"""

import pandas as pd
dataset_adilabad=pd.read_csv('/home/coder/project/workspace/NASCOM_CHANLLANGE/HEAT_WAVE_PREDICTION_MODEL+DATA/adilabad_dataset_final.csv')

dataset_adilabad.head()

dataset_adilabad[10:]

dataset_adilabad['Date'] = pd.to_datetime(dataset_adilabad['Date'])

dataset_adilabad[10:]

dataset_adilabad['Date'] =dataset_adilabad['Date'].dt.date

dataset_adilabad.shape

avg_by_date = dataset_adilabad.groupby('Date')['temp_max (⁰C)'].mean()
...
normal_temp =(40.4658+39.0803179)/2  # Mean maximum temperature in Celsius for the hottest month
...
for i in range(0,12):
  for index, row in dataset[i].iterrows():
    ...
    elif row['ARIMA Predictions'] >= 39.7:
