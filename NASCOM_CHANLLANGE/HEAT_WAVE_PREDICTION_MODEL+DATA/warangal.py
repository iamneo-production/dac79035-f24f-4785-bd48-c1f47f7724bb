...
Original file is located at
    https://colab.research.google.com/drive/1gRkKJJssjqbagK9MzHkr7sSPGhF1pwZH
"""

import pandas as pd
dataset_W=pd.read_csv('/home/coder/project/workspace/NASCOM_CHANLLANGE/HEAT_WAVE_PREDICTION_MODEL+DATA/warangal_dataset_final.csv')

dataset_W.head()

dataset_W[10:]

dataset_W['Date'] = pd.to_datetime(dataset_W['Date'])

dataset_W[10:]

dataset_W['Date'] =dataset_W['Date'].dt.date

dataset_W.shape

avg_by_date = dataset_W.groupby('Date')['temp_max (?C)'].mean()
...
normal_temp =(41.42+39.45)/2  # Mean maximum temperature in Celsius for the hottest month
